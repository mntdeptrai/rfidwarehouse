...
graph TD
    subgraph Presentation_Layer["TẦNG GIAO DIỆN (PRESENTATION LAYER)"]
        ...
        subgraph Desktop_Screens["Desktop Views"]
            ...
            Desktop --> D_Inventory["desktop_inventory_view.dart (Kiểm Kê Tồn Kho)"]
            Desktop --> D_Lookup["desktop_lookup_view.dart (Tra Cứu Chi Tiết)"]
            Desktop --> D_Warehouse["desktop_warehouse_management_view.dart (Sơ Đồ 2D)"]
